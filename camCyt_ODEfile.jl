module Module_camCyt
    ...
    function morotti_camCytODE!(du, u,  p, CaCyt,t)
    ## State variables
    ...
    ## write to global variables for adjusting Ca buffering in EC coupling model
        @variables CaCyt(t) CaCyt ~ 1e-3*(2*CaMKIItot*(rcnCKtt2-rcnCKb2b) - 2*(rcn02+rcn24+rcn02B+rcn24B+rcnCa4CaN+rcn02CaN+rcn24CaN))   # [uM/msec]
    
        return du
    end

    export morotti_camCytODE
    export CaCyt
