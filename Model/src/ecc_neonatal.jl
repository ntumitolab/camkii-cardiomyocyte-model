...
function build_neonatal_ecc_sys(;
    ...
    @unpack eqs_camkii, CaMKAct = get_camkii_simp_eqs(;Ca=Cai_mean, ROS)
    @unpack INaCa, ICaL, ICaT, ICab, eqs_ica = get_ica_eqs(na_i, Cai_sub_SL, na_o, ca_o, vm; LCCb_PKAp, CaMKAct)
    ...
    @unpack eqs_sr, Jrel, Jup, Jleak, Jtr, JCa_SR = get_ser_eqs(Cai_sub_SR; fracPLB_CKp=CaMKAct*0.2, fracPLBp, RyR_CKp=CaMKAct*0.5, V_sub_SR)
