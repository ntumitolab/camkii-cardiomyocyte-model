...
function get_bar_sys(ATP=5000μM, ISO=0μM; remove_conserved=true)
    rn = @reaction_network begin
        @parameters b1ARtot Gstot PDEtot PKItot I1tot PLBtot PLMtot TnItot LCCtot PKACII_LCCtot PKAIItot PKAII_KURtot IKurtot PP1_KURtot PP1tot RItot RIItot ACtot
