...
#---
plot(sol, idxs=sys.CaMKAct*100, title="Active CaMKII", label=false)

# ## ROS 1uM
prob2 = remake(prob, p=[sys.ROS => 1μM])
...
#---
plot(sol2, idxs=sys.CaMKAct*100, title="Active CaMKII", label=false)

# ## ROS 5uM
prob3 = remake(prob, p=[sys.ROS => 5μM])
...
plot!(sol2, idxs=sys.CaMKAct*100, lab="ROS=1uM")
plot!(sol3, idxs=sys.CaMKAct*100, lab="ROS=5uM", xlabel="Time (ms)", ylabel="Active fraction (%)")
